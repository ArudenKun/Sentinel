...
public class AutoGrid : Grid
{
    ...
    )
    {
        foreach (var child in grid.Children)
        {
            child.SetValue(
                ...
                grid.ChildVerticalAlignment ?? AvaloniaProperty.UnsetValue
            );
        }
    }
    ...
    public static readonly AvaloniaProperty ColumnCountProperty = AvaloniaProperty.RegisterAttached<
        Control,
        int
    >("ColumnCount", typeof(AutoGrid), 1);

    public static readonly AvaloniaProperty ColumnWidthProperty = AvaloniaProperty.RegisterAttached<
        Control,
        GridLength
    >("ColumnWidth", typeof(AutoGrid), GridLength.Auto);

    public static readonly AvaloniaProperty IsAutoIndexingProperty = AvaloniaProperty.Register<
        AutoGrid,
        bool
    >("IsAutoIndexing", true);
    ...
    public static readonly AvaloniaProperty RowCountProperty = AvaloniaProperty.RegisterAttached<
        Control,
        int
    >("RowCount", typeof(AutoGrid), 1);

    public static readonly AvaloniaProperty RowHeightProperty = AvaloniaProperty.RegisterAttached<
        Control,
        GridLength
    >("RowHeight", typeof(AutoGrid), GridLength.Auto);

    static AutoGrid()
    {
        AffectsMeasure<AutoGrid>(
        ...
        ChildHorizontalAlignmentProperty.Changed.AddClassHandler<AutoGrid>(
        ...
        ChildVerticalAlignmentProperty.Changed.AddClassHandler<AutoGrid>(
    ...
    /// <summary>
    /// Measures the children of a <see cref="T:Grid"/> in anticipation of arranging them during the <see cref="M:ArrangeOverride"/> pass.
    /// </summary>
