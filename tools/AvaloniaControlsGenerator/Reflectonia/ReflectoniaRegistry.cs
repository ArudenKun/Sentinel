...
{
    private static readonly FieldInfo? s_registered = typeof(AvaloniaPropertyRegistry).GetField(
        "_registered",
        BindingFlags.NonPublic | BindingFlags.Instance
    );

    private static readonly FieldInfo? s_attached = typeof(AvaloniaPropertyRegistry).GetField(
        "_attached",
        BindingFlags.NonPublic | BindingFlags.Instance
    );

    private static readonly FieldInfo? s_registeredRoutedEvents =
        typeof(RoutedEventRegistry).GetField(
    ...
    public Dictionary<
        Type,
        Dictionary<int, AvaloniaProperty>
    >? RegisteredAttachedProperties { get; }
