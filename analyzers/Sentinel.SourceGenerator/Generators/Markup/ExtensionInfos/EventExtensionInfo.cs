...
public class EventExtensionInfo : IMemberExtensionInfo
{
    ...
    public bool HasStandardSignature =>
        ...
        && EventParameterTypes[0] == "System.Object"
    ...
    public EventExtensionInfo(IEventSymbol eventInfo)
    {
        ...
        if (
            eventArgType.OriginalDefinition.SpecialType == SpecialType.System_Nullable_T
            && eventInfo.Type is INamedTypeSymbol nts
        )
        {
